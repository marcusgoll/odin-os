...
| `state/migration/drafts/skills/blog-writer.md` | Blog Writer | Draft migrated from legacy writing skill. | Use only for migration triage. | Legacy source `.claude/skills/blog-writer/SKILL.md`. | Draft-valid for migration review only. | Overlaps marketing/content legacy skills. | Remove or leave archived unless Odin gains a governed content workflow. |
| `state/migration/drafts/skills/brand-ad-generator.md` | Brand Ad Generator | Draft migrated from legacy brand/ad skill. | Use only for migration triage. | Legacy source `.claude/skills/brand-ad-generator/SKILL.md`. | Draft-valid for migration review only. | Overlaps marketing/content legacy skills. | Remove or archive; not core to Odin-OS orchestration. |
...
| `state/migration/drafts/skills/claude-api.md` | Building LLM-Powered Applications with Claude | Draft migrated from legacy Claude API skill. | Use only for migration review or provider capability reference. | Legacy source `.claude/skills/claude-api/SKILL.md`. | Draft-valid for migration review only. | Overlaps executor/provider docs; not current runtime. | Replace with provider-neutral executor docs if needed. |
...
| `state/migration/drafts/skills/slack-gif-creator.md` | Slack GIF Creator | Draft migrated from legacy Slack media skill. | Use only for migration triage. | Legacy source `.agents/skills/slack-gif-creator/SKILL.md`. | Draft-valid for migration review only. | Overlaps none in current Odin core. | Remove or archive; not core to Odin-OS orchestration. |
