...
func isKnownBrowserProfileArtifactAction(value string) bool {
	switch strings.ToLower(strings.TrimSpace(value)) {
	case "create-fixture", "list", "show", "revoke":
		return true
	default:
		return false
	}
