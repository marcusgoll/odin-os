...
func TestConversationTranscriptRecordedContract(t *testing.T) {
	...
	if got := StreamConversation; got != StreamType("conversation") {
		t.Fatalf("StreamConversation = %q, want %q", got, StreamType("conversation"))
	}
...
func TestMemorySummaryRecordedContract(t *testing.T) {
	...
	if got := EventMemorySummaryRecorded; got != Type("memory_summary.recorded") {
		t.Fatalf("EventMemorySummaryRecorded = %q, want %q", got, Type("memory_summary.recorded"))
	}
